...
import OrdersSettings from "./pages/company/CompanySettings/Modules/OrdersSettings";
import InvoicesSettings from "./pages/company/CompanySettings/Modules/InvoicesSettings";
import OffersSettings from "./pages/company/CompanySettings/Modules/OffersSettings";
...
import OffersListPage from "./pages/oms/offers/OffersListPage";
import OfferCreatePage from "./pages/oms/offers/OfferCreatePage";
import OfferDetailPage from "./pages/oms/offers/OfferDetailPage";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="oms/offers/new" element={<OfferCreatePage />} />
