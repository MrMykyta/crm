...
module.exports.getById = async (req, res) => {
  try {
    const item = await pickTaskService.getById(req.params.id, { user: req.user });
...
module.exports.create = async (req, res) => {
  try {
    ...
    const created = await pickTaskService.create(payload, { user: req.user });
...
module.exports.update = async (req, res) => {
  try {
    const updated = await pickTaskService.update(req.params.id, req.body, { user: req.user });
...
module.exports.remove = async (req, res) => {
  try {
    const n = await pickTaskService.remove(req.params.id, { user: req.user });
