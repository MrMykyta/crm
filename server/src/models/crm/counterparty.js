  ...
  Counterparty.init(
    {
      ...
      pesel: { type: DataTypes.STRING(11), allowNull: true },
      ...
      registryVerified: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false, field: 'registry_verified' },
      registryVerifiedAt: { type: DataTypes.DATE, allowNull: true, field: 'registry_verified_at' },
      registryVerifiedSource: { type: DataTypes.STRING(128), allowNull: true, field: 'registry_verified_source' },
      registryVerifiedEnv: { type: DataTypes.STRING(32), allowNull: true, field: 'registry_verified_env' },
      registryVerifiedMock: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false, field: 'registry_verified_mock' },
      registrySnapshot: { type: DataTypes.JSONB, allowNull: true, field: 'registry_snapshot' },
      registrySnapshotHash: { type: DataTypes.STRING(64), allowNull: true, field: 'registry_snapshot_hash' },
